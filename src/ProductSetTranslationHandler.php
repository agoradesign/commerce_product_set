...
/**
 * Defines the translation handler for product sets.
 *
 * Based on NodeTranslationHandler and ProductTranslationHandler.
 */
class ProductSetTranslationHandler extends ContentTranslationHandler {
  ...
  public function entityFormAlter(array &$form, FormStateInterface $form_state, EntityInterface $entity) {
    ...
    if (isset($form['content_translation'])) {
      $form['content_translation'] += [
        '#group' => 'advanced',
        '#attributes' => [
          'class' => ['product-set-translation-options'],
        ],
      ];
      $form['content_translation']['#weight'] = 100;
      // The basic entity values will be used, no need for specific elements.
  ...
  public function entityFormEntityBuild($entity_type, EntityInterface $entity, array $form, FormStateInterface $form_state) {
    /** @var \Drupal\commerce_product_set\Entity\ProductSetInterface $entity */
